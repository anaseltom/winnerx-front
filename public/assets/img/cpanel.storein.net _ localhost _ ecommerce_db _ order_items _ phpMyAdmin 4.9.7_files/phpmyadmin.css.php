...
<head>
    ...
    <link href="/cPanel_magic_revision_1629840575/unprotected/cpanel/style_v2_optimized.css" rel="stylesheet" type="text/css" />
...
.copyright {
  ...
  background-size: 25px auto;
    ...
    <style type="text/css">
        img {
            behavior: url(/cPanel_magic_revision_1605648132/unprotected/cp_pngbehavior_login.htc);
        }
    </style>
    <![endif]-->
...
<input type="hidden" id="goto_uri" value="/3rdparty/phpMyAdmin/phpmyadmin.css.php?nocache=6511950856ltr&amp;server=1" />
    ...
    <div id="notify">
        <noscript>
            <div class="error-notice">
                <img src="/cPanel_magic_revision_1605643887/unprotected/cpanel/images/notice-error.png" alt="Error" align="left"/>
        ...
        <div id="login-container">
            ...
            <div id="login-sub-container">
                    <div id="login-sub-header">
                        ...
                        <img class="main-logo" src="/cPanel_magic_revision_1605643887/unprotected/cpanel/images/cpanel-logo.svg" alt="logo" />
