    ...
    <>
      ...
      <div className="pharagraph_wrapper">
        ...
        <div className="MuiContainer-root MuiContainer-maxWidthLg">
          <h5 className="section-heading">Privacy Policy</h5>
          <div className="">
            <pre className="preTag">
              Winner Deals General Trading LLC operates the
              https://www.winnerx.com website, which provides the SERVICE. This
              page is used to inform website visitors regarding our policies
              with the collection, use, and disclosure of Personal Information
              if anyone decided to use our Service, the WinnerX website. If you
              ...
              https://www.winnerx.com, unless otherwise defined in this Privacy
              Policy.
            </pre>
            <h5 className="pp-heading">Information Collection and Use</h5>
            <p>
            ...
            <h5 className="pp-heading">Log Data</h5>
            <p>
            ...
            <h5 className="pp-heading">Cookies</h5>
            <pre className="preTag">
              ...
              general information on cookies, please read 'Cookies' article from
              the Privacy Policy Generator.
            </pre>
            <h5 className="pp-heading">Service Providers</h5>
            <p>
            ...
            <h5 className="pp-heading">Security</h5>
            <p>
            ...
            <h5 className="pp-heading">Links to Other Sites</h5>
            <p>
            ...
            <h5 className="pp-heading">Children's Privacy</h5>
            <p>
            ...
            <h5 className="pp-heading">Changes to This Privacy Policy</h5>
            <p>
            ...
            <h5 className="pp-heading">Contact Us</h5>
            <p>
