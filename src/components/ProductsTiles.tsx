...
const Products: React.FC<any> = ({feature, title, filterControl, filterBy}) => {
    ...
    return (
        <section className="featured spad tiles_products">
            {/* <div className="container"> */}
                <div className="row featured__filter" style={{justifyContent: "center"}}>
                    {
                    products_list && products_list.length >0 && products_list.filter((product:any)=>filterProd(product)).slice(2, 5).map((ar: any) => {
                        return (

                            <div onClick={(e)=> {setProdIsOpen(true);setUpdateProdSummary(ar);}} key={ar.id} className={`col-lg-4 col-md-12 col-sm-12 tiles mix ${ar.categoryName}`}>
                                <div className="featured__item set-bg" style={{backgroundImage: `url('assets/img/rangerover2.jpeg')`}}>
                                    <div className="featured__item__pic" data-setbg="/assets/img/featured/feature-1.jpg">
                                        ...
                                        <div className="chance">
                                            <img src="assets/img/chance.png" alt=""/>
                                    ...
                                    <div className="featured__item__text">
                                        {/* <span>Chance to win Macbook Pro</span> */}
                                        <span className="title">{ar.productName}</span>
                                        <span className="subtitle">{ar.currencyCode} {numberWithCommas(ar.unitPrice)}</span>
                                        {/* <h5>$30.00</h5> */}
                                        <div className="prod_default_prod" style={{backgroundImage: `url('${ar.image_url_main}')`}}></div>
                                    </div>
                                </div>
